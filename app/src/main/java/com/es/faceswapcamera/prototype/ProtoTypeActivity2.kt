...
import com.es.faceswapcamera.prototype.facedetection.FaceContourDetectorProcessor2
import com.google.android.gms.common.annotation.KeepName
import com.google.firebase.ml.common.FirebaseMLException
import kotlinx.android.synthetic.main.activity_proto_type_2.*
import java.io.IOException

@KeepName
class ProtoTypeActivity2 : AppCompatActivity(), OnRequestPermissionsResultCallback,
    OnItemSelectedListener, CompoundButton.OnCheckedChangeListener {

    private var cameraSource: CameraSource? = null
    private var selectedModel = FACE_CONTOUR
    private lateinit var faceImagePreview: ImagePreview2
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_proto_type_2)
