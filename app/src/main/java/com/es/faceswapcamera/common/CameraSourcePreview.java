...
package com.es.faceswapcamera.common;
...
import com.es.faceswapcamera.common.preference.PreferenceUtils;
...
public class CameraSourcePreview extends ViewGroup {
  ...
  private void changeExposure() {
    if (cameraSource.camera == null) return;



    Camera.Parameters parameters = cameraSource.camera.getParameters();
    ...
    try {
      ...
      cameraSource.camera.setParameters(parameters);

    } catch (Exception ex) {
      ex.printStackTrace();
      Log.i( "cameraSourcePreview","setParameters failed~");
